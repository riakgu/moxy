...
export default function DeviceCard({
  device, slots, onProvision, onDeleteDevice,
    ...
    >
      ...
      <button
        ...
        className="w-full px-5 py-4 flex items-center justify-between cursor-pointer
          hover:bg-bg-surface-hover/30 transition-colors text-left"
      >
        <div className="flex items-center gap-4">
          <span className="font-mono text-2xl font-semibold text-accent-cyan">{device.alias}</span>
          <span className="text-sm text-text-secondary">{device.carrier || 'Unknown carrier'}</span>
